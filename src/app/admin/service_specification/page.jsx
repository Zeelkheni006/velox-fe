    ...
    <Layout>
      <div className={styles.container}>
        <div className={styles.headerContainer}>
          <div>
            <span className={styles.breadcrumb}>Service Specification</span> &gt;{" "}
            <span className={styles.breadcrumb}>Service</span> &gt;{" "}
            <span className={styles.breadcrumbActive}>Specification</span>
          </div>
        </div>

        <div className={styles.card}>
          <h5 className={styles.title}>Service Specifications</h5>
