...
export default function OrdersTable() {
    ...
    <Layout>
      <div className={styles.container}>
        ...
        <div className={styles.card}>
          ...
          <div className={styles.filters}>
            ...
            <div className={styles.filtersBottom}>
              <div className={styles.leftControls}>
                ...
                <div className={styles.showEntriesBelow}>
                  Show{' '}
                  <select
          ...
          {/* Table */}
          {loading ? (
            <div className={styles.spinnerWrapper}>Loading...</div>
          ) : (
            <>
                ...
                <thead>
                  <tr>
                    <th onClick={() => handleSort('id')} style={{ cursor: 'pointer' }}>
                      Id
                      <SortArrow direction={sortConfig.key === 'id' ? sortConfig.direction : null} />
                    </th>
                    <th onClick={() => handleSort('user_name')} style={{ cursor: 'pointer' }}>
                      User Name
                      <SortArrow
                        direction={sortConfig.key === 'user_name' ? sortConfig.direction : null}
                      />
                    </th>
  ...
  <li
    onClick={() =>
     router.push(
  `/admin/order-view?id=${order.id}&user_name=${encodeURIComponent(order.user_name)}&order_number=${order.order_number}&services=${encodeURIComponent(order.services)}&total_quantity=${order.total_quantity}&total_amount=${order.total_amount}&city=${order.city}&status=${order.status}`
)
