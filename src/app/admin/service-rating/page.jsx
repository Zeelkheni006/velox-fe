...
export default function ServiceRating() {
  ...
  const currentRatings = filtered.slice(startIndex, endIndex);
                ...
                <tr key={r.id}>
                  ...
                  <td>
                    {Array.from({ length: 5 }, (_, i) => (
                      <span
                        key={i}
                        className={
                          i < r.rating ? styles.filledStar : styles.emptyStar
                        }
                      >
                        ★
                      </span>
                  ...
                  <td>
                    <span
                      className={`${styles.status} ${
                        r.status === "ACTIVE" ? styles.active : styles.inactive
                      }`}
                    >
                      {r.status}
                    </span>
                  ...
                  <td>
                    <button
                      ...
                      onClick={() =>
                        router.push(`/admin/edit-service-rating?id=${r.id}`)
                      }
                    >
                      Edit
                    </button>
